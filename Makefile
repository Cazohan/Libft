...
#*   Updated: 2016/10/26 15:32:36 by lherbelo         ###   ########.fr       *#
#*                                                                            *#
#* ************************************************************************** *#
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c\
	  ...
	  get_next_line.c ft_abs.c ft_fabs.c
...
OBJ = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o\
	  ...
	  get_next_line.o ft_abs.o ft_fabs.o
...
$(NAME):
	...
	@ar rc $(NAME) $(OBJ)
	@echo "$(GREEN)Et pouf ! On index tout sa !$(RESET)"
	@ranlib $(NAME)

clean:
	@echo "$(CYAN)Arrrr! Petit cleanachhhh!$(RESET)"
	@rm -f $(OBJ)

fclean: clean
	@echo "$(MAGENTA)Nettoyache ! $(BOLDRED)BAC +5 femme de ménache,"\
	"$(BOLDWHITE) saleté tenace!!!!$(RESET)"
	@rm -f $(NAME)

re :
	@echo "$(GREEN)bah ouai quoi!!! On prend tout et on recommence mon ptit!!!$(RESET)"
	make fclean
	make
